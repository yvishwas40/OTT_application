                            ...
                            <div key={topic.id} className="card p-4 hover:border-slate-700 transition-colors">
                                <div className="flex justify-between items-start">
                                    <div className="flex items-center">
                                        <span className="p-2 bg-slate-800 text-yellow-500 rounded-lg mr-3 border border-slate-700">
                                            <Tags className="h-5 w-5" />
                                        </span>
                                        <h3 className="text-lg font-semibold text-white">{topic.name}</h3>
                                    </div>
                                    <div className="flex space-x-1">
                                        <button className="p-1.5 text-gray-400 hover:text-yellow-500 hover:bg-slate-800 rounded transition-colors">
