        ...
        <div className="card p-6">
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
            ...
            >
              ...
              <span className="font-medium text-gray-200 group-hover:text-white">Manage Series</span>
            </Link>
            <Link
              href="/cms/lessons"
              className="flex items-center gap-x-3 rounded-lg border border-slate-700 p-4 hover:bg-slate-800 transition-colors group"
            >
              ...
              <span className="font-medium text-gray-200 group-hover:text-white">Manage Episodes</span>
            </Link>
            <Link
              href="/cms/topics"
              className="flex items-center gap-x-3 rounded-lg border border-slate-700 p-4 hover:bg-slate-800 transition-colors group"
            ...
            >
              ...
              <span className="font-medium text-gray-200 group-hover:text-white">View OTT Platform</span>
            </Link>
          </div>
        </div>
      </div>
