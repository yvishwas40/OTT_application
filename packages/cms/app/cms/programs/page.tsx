    ...
    <CMSLayout>
      <div className="space-y-6">
        ...
        <div className="flex justify-between items-center">
          ...
          <Link href="/cms/programs/new" className="btn-primary flex items-center gap-x-2">
        ...
        {loading ? (
          ...
          <div className="card p-12 text-center">
            ...
            <Link href="/cms/programs/new" className="btn-primary inline-flex items-center gap-x-2">
              <Plus className="h-4 w-4" />
              Create Series
            </Link>
          </div>
                ...
                <div className="p-4 bg-slate-900">
                  ...
                  <div className="flex justify-between items-center pt-3 border-t border-slate-800 mt-3">
                    <div className="flex space-x-2">
                      <Link href={`/cms/programs/${program.id}`} className="p-1.5 text-gray-400 hover:text-yellow-500 hover:bg-slate-800 rounded transition-colors">
